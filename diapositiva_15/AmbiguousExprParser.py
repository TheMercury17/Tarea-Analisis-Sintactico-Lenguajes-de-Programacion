...
class AmbiguousExprParser ( Parser ):
    ...
    class ProgramContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return AmbiguousExprParser.RULE_program
    ...
    def program(self):
        ...
        localctx = AmbiguousExprParser.ProgramContext(self, self._ctx, self.state)
    ...
    class MulAmbContext(ExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterMulAmb" ):
                listener.enterMulAmb(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitMulAmb" ):
                listener.exitMulAmb(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitMulAmb" ):
                return visitor.visitMulAmb(self)
            else:
                return visitor.visitChildren(self)


    class NumAmbContext(ExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterNumAmb" ):
                listener.enterNumAmb(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitNumAmb" ):
                listener.exitNumAmb(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitNumAmb" ):
                return visitor.visitNumAmb(self)
            else:
                return visitor.visitChildren(self)


    class AddAmbContext(ExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterAddAmb" ):
                listener.enterAddAmb(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitAddAmb" ):
                listener.exitAddAmb(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitAddAmb" ):
                return visitor.visitAddAmb(self)
            else:
                return visitor.visitChildren(self)
    ...
    def expr(self, _p:int=0):
        ...
        try:
            self.enterOuterAlt(localctx, 1)
            localctx = AmbiguousExprParser.NumAmbContext(self, localctx)
            self._ctx = localctx
            _prevctx = localctx
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = AmbiguousExprParser.AddAmbContext(self, AmbiguousExprParser.ExprContext(self, _parentctx, _parentState))
                        ...
                        localctx = AmbiguousExprParser.MulAmbContext(self, AmbiguousExprParser.ExprContext(self, _parentctx, _parentState))
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expr)
                        self.state = 13
